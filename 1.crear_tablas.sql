...
CREATE TABLE IF NOT EXISTS public.cliente (
    id BIGINT GENERATED ALWAYS AS IDENTITY,
    nombre VARCHAR(150) NULL, -- Permite NULL porque las EMPRESAS usan razon_social
...
CREATE TABLE IF NOT EXISTS public.movimiento_kardex (
    id BIGINT GENERATED ALWAYS AS IDENTITY,
...
CREATE TABLE IF NOT EXISTS public.detalle_cotizacion_producto (
    id BIGINT GENERATED ALWAYS AS IDENTITY,
...
CREATE TABLE IF NOT EXISTS public.detalle_cotizacion_servicio (
    id BIGINT GENERATED ALWAYS AS IDENTITY,
    cotizacion_id BIGINT NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.detalle_consumo_material (
    id BIGINT GENERATED ALWAYS AS IDENTITY,
    orden_trabajo_id BIGINT NOT NULL,
    producto_id BIGINT NOT NULL,
    observacion TEXT,
...
-- 20. NOTA_SERVICIO
CREATE TABLE IF NOT EXISTS public.nota_servicio (
    id BIGINT GENERATED ALWAYS AS IDENTITY,
    orden_trabajo_id BIGINT NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.sistema_instalado (
    id BIGINT GENERATED ALWAYS AS IDENTITY,
    orden_trabajo_id BIGINT NOT NULL,
    establecimiento_id BIGINT NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.alerta_notificacion (
    id BIGINT GENERATED ALWAYS AS IDENTITY,
...
CREATE TABLE IF NOT EXISTS public.mantenimiento_ticket (
    id BIGINT GENERATED ALWAYS AS IDENTITY,
    sistema_instalado_id BIGINT NOT NULL,
